...
![wl-deploy.png](/assets/images/v3/workload/wl-deploy.png)
...
![wl-009.png](/assets/images/v3/workload/wl-009.png){: width="1200" }
...
![wl-010.png](/assets/images/v3/workload/wl-010.png){: width="1200" }
![wl-010-01.png](/assets/images/v3/workload/wl-010-01.png){: width="1200" }
...
![wl-011.png](/assets/images/v3/workload/wl-011.png){: width="1200" }
...
![wl-013.png](/assets/images/v3/workload/wl-013.png){: width="1200" }
...
![wl-012.png](/assets/images/v3/workload/wl-012.png){: width="600" }

![wl-012-01.png](/assets/images/v3/workload/wl-012-01.png){: width="600" }

**오토스케일기준**
- CPU
- 메모리

![wl-014.png](/assets/images/v3/workload/wl-014.png){: width="600" }{: .center}
...
![deployment-delete.png](/assets/images/v3/workload/deployment-delete.png){: width="1200" }
