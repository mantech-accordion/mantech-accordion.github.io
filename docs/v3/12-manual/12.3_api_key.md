...
![3_api_key.png](/assets/images/v3/manual/3_api_key.png){: width="1200" }

---

API KEY 발급 화면에서 `생성` 버튼을 클릭합니다.
![3_create_api_key_1.png](/assets/images/v3/manual/3_create_api_key_1.png){: width="1200" }

이후 `만료일`, `KEY 이름`을 입력 합니다.
![3_create_api_key_1.png](/assets/images/v3/manual/3_create_api_key_2.png){: width="1200" }

설정을 마쳤으면 `생성` 버튼을 클릭합니다.
![3_create_api_key_2.png](/assets/images/v3/manual/3_create_api_key_3.png){: width="1200" }

생성한 KEY를 복사하여 API 호출에 사용합니다.
![3_create_api_key_3.png](/assets/images/v3/manual/3_create_api_key_4.png){: width="800" }

생성한 KEY는 아래 화면과 같이 나타납니다.
![3_create_api_key_3.png](/assets/images/v3/manual/3_create_api_key_5.png){: width="800" }
