...
![catalog-trigger](/assets/images/v2/application/trigger/catalog-trigger.png){: width="1200" }

**카탈로그 트리거 설정**

트리거를 생성하면 다양한 설정을 진행 할 수 있습니다.
![catalog-option](/assets/images/v2/application/trigger/catalog-trigger-option.png){: width="1000" }
...
![catalog-trigger-check](/assets/images/v2/application/trigger/catalog-trigger-check.png){: width="1200" }

## 카탈로그 트리거 수정
원하는 트리거의 수정 버튼을 눌러 트리거 수정도 가능합니다.
![catalog-trigger-modify](/assets/images/v2/application/trigger/catalog-trigger-modify.png){: width="1200" }

## 카탈로그 트리거 삭제
삭제할 트리거의 삭제 버튼을 눌러 트리거 삭제도 가능합니다.
![catalog-trigger-delete](/assets/images/v2/application/trigger/catalog-trigger-delete.png){: width="1200" }
