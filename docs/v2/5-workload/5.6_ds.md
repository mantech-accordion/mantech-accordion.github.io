...
![wl-ds.png](/assets/images/v2/workload/wl-ds.png)
...
![wl-016.png](/assets/images/v2/workload/wl-016.png){: width="1200" }


## 데몬셋 생성
`+생성` 을 선택하면 나타나는 모달에서 쿠버네티스 데몬셋 리소스 정보를 입력하여 생성할 수 있습니다.

![daemonset-create.png](/assets/images/v2/workload/daemonset-create.png){: width="1200" }
...
![daemonset-delete.png](/assets/images/v2/workload/daemonset-delete.png){: width="1200" }
