...
![audit.png](/assets/images/v2/monitoring/audit.png)

---
## 화면 구성

![audit_log.png](/assets/images/v2/monitoring/audit_log.png){: width="1200" }
...
![audit_log_detail.png](/assets/images/v2/monitoring/audit_log_detail.png){: width="1200" }
...
![audit_log_condition.png](/assets/images/v2/monitoring/audit_log_detail.png){: width="1200" }
