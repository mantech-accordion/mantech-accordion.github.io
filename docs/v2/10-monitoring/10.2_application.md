...
![app.png](/assets/images/v2/monitoring/app.png)
...
![2_app_overview.png](/assets/images/v2/monitoring/2_app_overview.png){: width="1200" }
...
![2_active_service.png](/assets/images/v2/monitoring/2_active_service.png){: width="1200" }
...
![2_active_service_detail.png](/assets/images/v2/monitoring/2_active_service_detail.png){: width="1200" }
...
![2_tps_todaytps.png](/assets/images/v2/monitoring/2_tps_todaytps.png){: width="1000" }
...
![2_visitors_responsetime.png](/assets/images/v2/monitoring/2_visitors_responsetime.png){: width="1000" }
...
![2_cpu_memory.png](/assets/images/v2/monitoring/2_cpu_memory.png){: width="1000" }
...
![2_xlog_scatter.png](/assets/images/v2/monitoring/2_xlog_scatter.png){: width="1000" }
...
![2_xlog_details_info_header.png](/assets/images/v2/monitoring/2_xlog_details_info_header.png){: width="1200" }

**XLog Profile**

Profile 에서는 해당 메소드의 실행소요된 시간을 계산하여 표시합니다. 메소드들을 실행 관계를 트리형태로 표현하고 있습니다. 이전 단계와의 시작 시간 차이를 T-GAP으로 표시합니다.

![2_xlog_details_profile.png](/assets/images/v2/monitoring/2_xlog_details_profile.png){: width="1200" }
