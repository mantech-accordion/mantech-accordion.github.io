...
![event.png](/assets/images/v2/monitoring/event.png)

---

## 화면 구성

![event_log.png](/assets/images/v2/monitoring/event_log.png){: width="1200" }
...
![event_log_detail.png](/assets/images/v2/monitoring/event_log_detail.png){: width="1200" }
...
![event_log_condition.png](/assets/images/v2/monitoring/event_log_condition.png)
...
![container_reload.png](/assets/images/v2/monitoring/container_reload.png)
