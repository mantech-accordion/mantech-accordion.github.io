...
![ac-004.png](/assets/images/v2/ac/ac-004.png)

---
## 화면구성
생성된 클러스터롤바인딩 정보를 제공합니다.

![ac-013.png](/assets/images/v2/ac/ac-013.png){: width="1200" }
...
![ac-014.png](/assets/images/v2/ac/ac-014.png){: width="1000" }
...
![clusterrolebinding-delete.png](/assets/images/v2/ac/clusterrolebinding-delete.png){: width="1200" }