...
![group.png](/assets/images/v2/auth/group.png)
...
![4_group-create.png](/assets/images/v2/auth/4_group-create.png){: width="1200" }
...
![4_group-user-add.png](/assets/images/v2/auth/4_group-user-add.png){: width="1200" }

사용자에 그룹 추가 후 해당 그룹을 확인하면 그룹의 사용자 목록에 사용자가 추가된 것을 확인 할 수 있습니다.

![4_group-user-list.png](/assets/images/v2/auth/4_group-user-list.png){: width="1200" }
...
![4_group-global-member.png](/assets/images/v2/auth/4_group-global-member.png){: width="1200" }
...
![4_group-delete.png](/assets/images/v2/auth/4_group-delete.png){: width="1200" }
