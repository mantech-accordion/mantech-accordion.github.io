...
![config-004.png](/assets/images/v2/config/config-004.png)

---
## 화면구성
생성된 리밋레인지 정보를 제공합니다.

![config-009.png](/assets/images/v2/config/config-009.png){: width="1200" }
...
![limit-create.png](/assets/images/v2/config/limit-create.png){: width="1200" }
...
![config-010.png](/assets/images/v2/config/config-010.png){: width="1200" }
...
![limit-delete.png](/assets/images/v2/config/limit-delete.png){: width="1200" }
