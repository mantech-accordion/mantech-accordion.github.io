...
![alertpolicy-list.png](/assets/images/v2/setting/alertpolicy-list.png)
...
![alertpolicy-create.png](/assets/images/v2/setting/alertpolicy-create.png)

설정 정보에 대한 설명은 다음과 같습니다.

**알림 정책(표)**

![alertpolicy-table1.png](/assets/images/v2/setting/alertpolicy-table1.png)
...
![node-alert-rule.png](/assets/images/v2/setting/node-alert-rule.png)
...
![node-selector-alert-rule.png](/assets/images/v2/setting/node-selector-alert-rule.png)
...
- Is : Node의 알림을 트리거할 이벤트를 선택합니다.(`CPU/Memory/Disk`)
- Over : 알림 규칙의 임계치이다. 임계치를 넘어 갈 경우 알람이 발송됩니다.
![node-expression-alert-rule.png](/assets/images/v2/setting/node-expression-alert-rule.png)
...
![alertpolicy-delete.png](/assets/images/v2/setting/alertpolicy-delete.png)
